...
class AppAdminPostsEditAll extends Component {
  ...
  render () {
    return (
      <tr id="bulk-edit"
          className="inline-edit-row inline-edit-row-post inline-edit-post bulk-edit-row bulk-edit-row-post bulk-edit-post inline-editor">
...
export default AppAdminPostsEditAll
