...
class WidgetCalendar extends Component {
    ...
    select(day) {
        ...
        //     pathname: "/",
        //     query: {after: dateString, before: dateString}
        // });
    }
    ...
    renderHeader() {
        ...
        const previousIcon = (<a className="rc-calendar-prev-month-btn" role="button" title="Previous month (PageUp)"
                                 onClick={this.previousMonth.bind(this)}>‹</a>);
        return (
            <div className="calendar-header-container">
                {this.state.previousMonthEnable ? previousIcon : null}
        ...
        return (
            <tr role="row">
                {daysNames.map((item, key) => {
                    return (
                        <th role="columnheader" title={item.title} className="rc-calendar-column-header"
                            key={item.value}>
        ...
        return (
            <div className="paddedBox_2UY-S box_transparent_c4OJj sidebarBox_1-7Yk sidebarBoxPadding_y0KxM">
                <div className="content_DcBqe">
                    ...
                    <Telescope.components.WidgetHeader message="Read by date"/>
