    ...
    renderChild() {
        return (
            <div>
              <span>
                  {!!this.state.message ?
                      <div className="errorMessage_2lxEG">{this.state.message.message}</div> : null}'
...
module.exports = withRouter(UsersResetPassword);
export default withRouter(UsersResetPassword);
