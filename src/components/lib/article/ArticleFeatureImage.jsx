...
class ArticleFeatureImage extends Component {
  ...
  uploadImageToServer (file) {
    ...
    //   if (error) {
    //     // failure
    //     self.context.messages.showMessage(this, 'Upload image failure', 'error')
    //   } else {
    ...
    //     self.props.onFeatureImageChange('', fileId, fileObj.path)
    //   }
    // })
    //
          ...
          <span className="typeIcon_1y1HV" title="Image">
                            <svg width="20" height="20" viewBox="0 0 20 20">
                                <g fill="none">
                                    ...
                                    <path
                                      d="M2,10 L2,10 L2,10 C2,14.4092877 5.581722,18 10,18 L10,18 C14.4092877,18 18,14.418278 18,10 L18,10 C18,5.59071231 14.418278,2 10,2 L10,2 C5.59071231,2 2,5.581722 2,10 L2,10 Z M0,10 L0,10 C0,4.47990754 4.48338507,0 10,0 C15.5200925,0 20,4.48338507 20,10 C20,15.5200925 15.5166149,20 10,20 C4.47990754,20 0,15.5166149 0,10 L0,10 Z"
                                      fill="#FFF"/>
                                    <path
                                      d="M7 2C7.55225 2 8 1.55225 8 1 8 .44775 7.55225 0 7 0 6.44775 0 6 .44775 6 1 6 1.55225 6.44775 2 7 2zM0 6L2.24560547 2.06494141 8.16113281 6z"
  ...
  renderPreview () {
    ...
    if (!!preview && preview !== '') {
      switch (uploadType) {
        ...
        default:
          return this.renderThumbnailImage()
      }
    }
    return null
  }
